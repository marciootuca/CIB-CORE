...
@NoArgsConstructor
@Entity
@Table(name = "TB_PAG_DET_5")
public class PagamentoDetalhe5 implements AbstractRemessa {
	...
	private LinkedHashSet<String> campos = new LinkedHashSet<>(Arrays.asList(
			...
			"x5010DtEmissDoc", "x5011ComplTED", "x5011ComplTED2", "x5011ComplTED3", "g004CNAB3",
			"g059CodOcorrRetRem"
	));
	...
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "DET_5")
	@SequenceGenerator(sequenceName = "SEQ_TB_PAG_DET_5", allocationSize = 1, name = "DET_5")
	private Long cod;
	...
	@Column(name = "X5011_COMPL_TED", length = 30, nullable = false)
	private String x5011ComplTED; // Nome Reclamante TED Dep. Judicial

	@Column(name = "X5011_COMPL_TED2", length = 25, nullable = false)
	private String x5011ComplTED2; // Número Proc, TED Dep. Judicial

	@Column(name = "X5011_COMPL_TED3", length = 15, nullable = false)
	private String x5011ComplTED3; // PIS/PASEP TED Dep. Judicial

	@Column(name = "G004_CNAB3", length = 25, nullable = false)
