...
@Entity
@Table(name = "TB_PAG_H")
public class PagH implements AbstractRemessa {
	...
	private LinkedHashSet<String> campos = new LinkedHashSet<>(Arrays.asList(
			...
			"g033Cidade", "g034CEP", "g035SufixoCEP", "g036UF", "p014IndFormaPag", "g004CNAB2", "xCodigoOcorrencias"
	));
	...
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "H_PAG")
	@SequenceGenerator(sequenceName = "SEQ_TB_PAG_H", allocationSize = 1, name = "H_PAG")
	private Long cod;
	...
	@Column(name = "X_CODIGO_OCORRENCIAS", length = 10, nullable = false)
