...
@NoArgsConstructor
@Entity
@Table(name = "TB_HEADER_LOTE_TRIB")
public class HeaderLoteTrib implements AbstractRemessa {

	@Transient
	private LinkedHashSet<String> campos = new LinkedHashSet<>(Arrays.asList(
			"g001CodBancoComp", "g002LoteServico", "g003TipoRegistro", "g028TipoOperacao", "g025TipoServico",
			"g029FormaLancamento", "g030VersaoLayoutLote", "g004CNAB", "g005TipoInscEmp", "g030VersaoLayoutLote",
			"g006NumInscEmp", "g007CodConvBanc", "g008AgenciaConta", "g009DigitoVerifAg", "g010NumeroCC",
			"g011DigitoVerifCC", "g012DigitoVerifACC", "g013Nome", "g031Mensagem", "g032Endereco",
			"g032Numero", "g032Complemento", "g033Cidade", "g034CEP", "g035SufixoCEP", "g036UF",
			"p014IndFormaPag", "g004CNAB2", "g059CodOcorrRetRem"
	));
	...
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "H_TRB")
	@SequenceGenerator(sequenceName = "SEQ_TB_HEADER_LOTE_TRIB", allocationSize = 1, name = "H_TRB")
	private Long cod;
