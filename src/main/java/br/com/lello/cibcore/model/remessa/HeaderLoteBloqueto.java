...
@NoArgsConstructor
@Entity
@Table(name = "TB_HEAD_LOTE_BLOQUETO")
public class HeaderLoteBloqueto implements AbstractRemessa {
	...
	private LinkedHashSet<String> campos = new LinkedHashSet<>(Arrays.asList(
			...
			"g004CNAB", "g030VersaoLayoutLote", "g004CNAB2", "g005TipoInscEmp", "g006NumInscEmp",
			"g007CodConvBanc", "g008AgenciaConta", "g009DigitoVerifAg", "g010NumeroCC", "g011DigitoVerifCC",
			"g012DigitoVerifACC", "g013Nome", "g004CNAB3"
	));
	...
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "H_BLQ")
	@SequenceGenerator(sequenceName = "SEQ_TB_HEAD_LOTE_BLOQUETO", allocationSize = 1, name = "H_BLQ")
	private Long cod;
